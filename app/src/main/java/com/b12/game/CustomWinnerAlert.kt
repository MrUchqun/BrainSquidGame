...
class CustomWinnerAlert(context: Context): Dialog(context){
    ...
    fun getTextResultTime() = textResultTime
    fun getTextResultSteps() = textResultSteps
    fun getTextRecordTime() = textRecordTime
    fun getTextRecordSteps() = textRecordSteps
    fun getLayoutResult() = layoutResult
